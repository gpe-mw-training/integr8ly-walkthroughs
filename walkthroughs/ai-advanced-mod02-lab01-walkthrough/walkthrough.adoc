...
. Click on link:https://tutorial-web-app-webapp.{openshift-app-host}[Tutorial Web Application, window="_blank"]
...
. Click on link:https://mdc-mdc-proxy-mobile-developer-console.{openshift-app-host}[Mobile Developer Services Console, window="_blank"]
