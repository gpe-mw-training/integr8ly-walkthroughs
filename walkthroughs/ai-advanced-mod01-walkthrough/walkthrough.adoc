...
[NOTE] If you are using *CodeReady Workspace* on OpenShift, you can skip this step and proceed to next section.
...
. Click on ink:{gogs-url}[Gogs Console, window="_blank"] to open the Gogs console.
. Login using your `{user-username}` and password.
